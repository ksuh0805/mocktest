...
public class MockServiceTest {
    ...
    // 4. champion 배열객체의 크기를 검증하는 로직이 1번 실행되었는지 테스트 하세요.
    @Test
    ...
    public void shouldAtMostThreeTimesWhenChampionGetName(){
        ...
        System.out.println("Champion Name :: " + champion.getName());
    ...
    @Test
    public void shouldNeverWhenChampionSetName(){
        Champion champion = mock(Champion.class);
        //champion.setName("티모");
        champion.setPosition("바텀");
        champion.setHasSkinCount(2);
    ...
    @Test
    public void shouldOneTimeInvocation200msForChampionGetGame(){
        Champion champion = mock(Champion.class);
        champion.setName("트페");
        champion.setPosition("미드");
